    ...
    public class AdminWriterBase
    {
        ...
        #region Static Methods
            ...
            internal static SqlParameter[] CreateInsertParameters(Admin admin)
            {
                ...
                if(admin != null)
                {
                    // Create [IndexOnSave] parameter
                    param = new SqlParameter("@IndexOnSave", admin.IndexOnSave);

                    // set parameters[0]
                    parameters[0] = param;

                    // Create [MemeFolder] parameter
                    param = new SqlParameter("@MemeFolder", admin.MemeFolder);

                    // set parameters[1]
                    parameters[1] = param;

                    // Create [SuppressDeletePrompt] parameter
                    param = new SqlParameter("@SuppressDeletePrompt", admin.SuppressDeletePrompt);
            ...
            internal static SqlParameter[] CreateUpdateParameters(Admin admin)
            {
                ...
                if(admin != null)
                {
                    // Create parameter for [IndexOnSave]
                    param = new SqlParameter("@IndexOnSave", admin.IndexOnSave);

                    // set parameters[0]
                    parameters[0] = param;

                    // Create parameter for [MemeFolder]
                    param = new SqlParameter("@MemeFolder", admin.MemeFolder);

                    // set parameters[1]
                    parameters[1] = param;

                    // Create parameter for [SuppressDeletePrompt]
                    param = new SqlParameter("@SuppressDeletePrompt", admin.SuppressDeletePrompt);
